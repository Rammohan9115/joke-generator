...
import FetchJoke from '@/components/JokeComponent'
...
function App() {
  ...
  return (
    <div>
       <h1 className='flex align-center justify-center mt-5 text-5xl font-semibold mr-2 px-2.5 py-0.5 rounded dark:text-gray-800 ml-2 drop-shadow-[0_1.2px_1.2px_rgba(1,1,1,5)] '> Joke <FaLaughSquint className="w-30"/> Creator </h1>
        <div className='flex flex-col	 text-gray-900'>
          ...
          {/* Render the JokeComponent component with the current joke parameters */}
              ...
              <h1 className='mt-10 align-center flex justify-center text-3xl font-semibold mr-2 px-2.5 py-0.5 rounded dark:text-gray-800 ml-2 drop-shadow-[0_1.2px_1.2px_rgba(1,1,1,0.8)]' >Results</h1> 
